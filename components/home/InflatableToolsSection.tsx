...
export function InflatableToolsSection() {
  ...
  const tools = [
    { src: '/inflatable hammer.png', alt: 'Inflatable Hammer', size: isMobile ? 169 : 225, position: 'oval-top-left' },
    { src: '/inflatable wrench.png', alt: 'Inflatable Wrench', size: isMobile ? 158 : 214, position: 'oval-top' },
    { src: '/inflatable screwdriver.png', alt: 'Inflatable Screwdriver', size: isMobile ? 146 : 203, position: 'oval-top-right' },
    { src: '/inflatable bits.png', alt: 'Inflatable Bits', size: isMobile ? 135 : 191, position: 'oval-left' },
    { src: '/inflatable level.png', alt: 'Inflatable Level', size: isMobile ? 158 : 214, position: 'oval-bottom-left' },
    { src: '/inflatable tape measure .png', alt: 'Inflatable Tape Measure', size: isMobile ? 146 : 203, position: 'oval-bottom' },
    { src: '/inflatable pliers.png', alt: 'Inflatable Pliers', size: isMobile ? 140 : 197, position: 'oval-right' },
  ]
