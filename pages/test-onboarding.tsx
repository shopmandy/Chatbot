...
export default function TestOnboarding() {
  ...
  const handleTest = async () => {
    ...
    try {
      ...
      if (response.success) {
        setResult(
          '✅ SUCCESS: Onboarding data saved successfully! Check your Supabase dashboard to see the new record.'
        )
    ...
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ marginTop: '30px' }}>
        ...
        <ol>
          ...
          <li>
            Click "Fetch Saved Data" to see the data retrieved from Supabase
          </li>
          <li>
            Go to your Supabase dashboard → Table Editor → onboarding_data
          </li>
