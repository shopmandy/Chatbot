  ...
  return (
    <div style={{ 
      ...
      <div style={{ marginBottom: '20px' }}>
        <p>This page helps you reset the onboarding status for testing purposes.</p>
        <p><strong>Current User:</strong> {user ? user.emailAddresses[0]?.emailAddress : 'Not signed in'}</p>
      </div>
      ...
      <div style={{ marginTop: '30px', padding: '15px', backgroundColor: '#f8f9fa', borderRadius: '5px' }}>
        <h3>Instructions:</h3>
        <ol>
          <li>Click "Check Current Status" to see your current onboarding status</li>
          <li>Click "Reset Onboarding" to force the onboarding to appear again</li>
          <li>You'll be redirected to the home page where onboarding should pop up</li>
